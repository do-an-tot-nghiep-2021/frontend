...
const UpdateSizeScreen = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            Swal.fire({
                title: 'Bạn có muốn thay đổi kích cỡ?',
                showCancelButton: true,
                confirmButtonText: 'cập nhật!',
            }).then((result) => {
                if (result.isConfirmed) {
                    updatesize(newData).then((response) => {
                ...
                <div className="col-lg-12 col-md-12 ml-auto">
                    <div className={`alert alert-success shadow ${success ? "show" : "fade"}`} role="alert" style={{ borderRadius: '3px' }}>
                        <div>
                            ...
                            <span style={{ fontSize: '18px' }} className="mb-0 font-weight-light"><b className="mr-1">Thành công!</b>Cập nhật thành công.</span>
                        </div>
                ...
                <div className="col-lg-12 col-md-12 ml-auto">
                    <div className={`alert alert-danger shadow ${error ? "show" : "fade"}`} role="alert" style={{ borderRadius: '3px' }}>
                        <div>
                            ...
                            <span style={{ fontSize: '18px' }} className="mb-0 font-weight-light"><b className="mr-1">Thất bại! </b> {error}.</span>
                        </div>
