...
const DashListSuccessData = ({ data }) => {
    ...
    return (
        <div className="m-portlet__body">
            <div class="d-flex justify-content-between">
                <div>
                    <h5>ĐƠN HÀNG ĐÃ HOÀN THÀNH
                        <span className="m-menu__link-badge">
                            <span className="m-badge m-badge--success ml-2 mb-2">{data.length}</span>
                        </span>
                    </h5>
                </div>
                <div>
                    {pages < 2 ? "" :
                        <ReactPaginate
                            ...
                            containerClassName={'pagination-success'}
                            pageClassName={'page-item-success'}
                            previousClassName={'page-item-success'}
                            nextClassName={'page-item-success'}
                            pageLinkClassName={'page-link-success'}
...
export default DashListSuccessData
